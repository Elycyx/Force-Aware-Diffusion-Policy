...
from fadp.common.sampler import (
    SequenceSampler, get_val_mask, downsample_mask)
from fadp.real_world.real_data_conversion import real_data_to_replay_buffer
from fadp.common.normalize_util import (
    ...
    def __init__(self,
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if type == 'rgb':
                ...
                # Separate force data from other low-dim observations
                if key == 'force':
        ...
        if n_obs_steps is not None:
            # only take first k obs from images and force
            for key in rgb_keys + lowdim_keys + force_keys:
...
def _get_replay_buffer(dataset_path, shape_meta, store):
    ...
    if action_shape == (2,):
        ...
        # 7D action space: dx,dy,dz,drx,dry,drz,gripper - keep all
        pass
    ...
    for key, shape in lowdim_shapes.items():
        if 'pose' in key and shape == (2,):
            ...
            zarr_resize_index_last_dim(zarr_arr, idxs=[0,1])
        elif 'force' in key and shape == (6,):
            # Keep all 6 force/torque dimensions
            pass
